...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','Calculadora.py',38),
  ('expression -> expression MINUS term','expression',3,'p_expression','Calculadora.py',39),
  ('expression -> term','expression',1,'p_expression_term','Calculadora.py',43),
  ('term -> term TIMES factor','term',3,'p_term','Calculadora.py',47),
  ('term -> term DIVIDE factor','term',3,'p_term','Calculadora.py',48),
  ('term -> factor','term',1,'p_term_factor','Calculadora.py',52),
  ('factor -> NUMBER','factor',1,'p_factor_num','Calculadora.py',56),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','Calculadora.py',60),
]